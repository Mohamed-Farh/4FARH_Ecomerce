...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // PAYMENT METHODS
        $managePaymentMethods   = Permission::create([ 'name' => 'manage_payment_methods',  'display_name' => 'Payment Methods',        'route' => 'payment_methods', 'module' => 'payment_methods', 'as' => 'payment_methods.index', 'icon' => 'fas fa-dollar-sign', 'parent' => '0', 'parent_original' => '0', 'appear' => '1', 'ordering' => '65', ]);
