...
class OrderController extends Controller
{
    ...
    {
        if (!auth()->user()->ability('superAdmin', 'manage_orders, show_orders')) {
    ...
    {
        if (!auth()->user()->ability('superAdmin', 'create_orders')) {
            return redirect('superAdmin/index');
        }
    ...
    {
        if (!auth()->user()->ability('superAdmin', 'display_orders')) {
            return redirect('superAdmin/index');
        }
    ...
    {
        if (!auth()->user()->ability('superAdmin', 'update_orders')) {
            return redirect('superAdmin/index');
        }
    ...
    {
        if (!auth()->user()->ability('superAdmin', 'delete_orders')) {
            return redirect('superAdmin/index');
        }
        $order->delete();

        return redirect()->route('superAdmin.orders.index')->with([
