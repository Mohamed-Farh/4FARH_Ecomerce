...
@section('content')
    ...
    <div class="container">
        <section class="hero pb-3 bg-cover bg-center d-flex align-items-center"
            style="background: url({{ asset('assets/slider/hero-banner-alt.jpg') }})">
