        ...
        <section class="pt-5">
            ...
            <div class="row">
                <div class="col-md-4 mb-4 mb-md-0"><a class="category-item" href="shop.html"><img class="img-fluid"
                            src="{{ asset('assets/categories/cat-img-1.jpg') }}" alt=""><strong
                ...
                <div class="col-md-4 mb-4 mb-md-0"><a class="category-item mb-4" href="shop.html"><img
                            class="img-fluid" src="{{ asset('assets/categories/cat-img-2.jpg') }}" alt=""><strong
                            class="category-item-title">Shoes</strong></a><a class="category-item" href="shop.html"><img
                            class="img-fluid" src="{{ asset('assets/categories/cat-img-3.jpg') }}" alt=""><strong
                ...
                <div class="col-md-4"><a class="category-item" href="shop.html"><img class="img-fluid"
                            src="{{ asset('assets/categories/cat-img-4.jpg') }}" alt=""><strong
