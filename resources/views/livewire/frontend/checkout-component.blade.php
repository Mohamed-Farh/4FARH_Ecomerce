                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <li>
                        <form wire:submit.prevent="applyDiscount()">
                            @if (!session()->has('copon'))
                                <input type="text" wire:model="copon_code" class="form-control" placeholder="Enter Your copon">
                            @endif
                            @if(session()->has('copon'))
                                <button type="button" wire:click.prevent="removecopon()" class="btn btn-danger btn-sm btn-block">
                                    <i class="fas fa-gift mr-2"></i> Remove copon
                                </button>
                            @else
                                <button type="submit" class="btn btn-dark btn-sm btn-block">
                                    <i class="fas fa-gift mr-2"></i> Apply copon
                                </button>
                            @endif
                        </form>
                    </li>
